        ...
        {value.map((item, index) => (
          ...
          >
            ...
            >
              ...
              <RemoveIcon size={12} className="hover:stroke-destructive"/>
            </button>
          </Badge>
        ))}
        {children}
...
>(({className, ...props}, ref) => {
  const {value, setOpen, inputValue, setInputValue, activeIndex, setActiveIndex} =
    useMultiSelect();
  return (
...
>(({className, value, children, ...props}, ref) => {
  ...
  return (
    <CommandItem
      ...
      className={cn(
        "rounded-md cursor-pointer px-2 py-1 transition-colors flex justify-between text-sm",
        className,
